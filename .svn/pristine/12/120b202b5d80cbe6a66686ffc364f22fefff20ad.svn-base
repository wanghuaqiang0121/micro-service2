...
public class BehavioralDevelopmentConfigService {
	 ...
	 * @description: 预警征
	 */
	public  Map<String, Object> getChildWarningSign(BehavioralDevelopmentConfig behavioralDevelopmentConfig){
		  return behavioralDevelopmentConfigMapper.getChildWarningSign(behavioralDevelopmentConfig);
	  }
}
