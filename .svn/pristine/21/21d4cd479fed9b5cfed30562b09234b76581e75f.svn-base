...
public class OrganizationUser extends BaseEntity {
	...
	@NotBlank(message = "{organization.user.account.not.blank}", groups = { Insert.class, Login.class,InsertOrganizationUser.class })
	private String account;
	@NotBlank(message = "{organization.user.password.not.blank}", groups = { Login.class, updatePassword.class,changePassword.class,AccountRepeat.class })
