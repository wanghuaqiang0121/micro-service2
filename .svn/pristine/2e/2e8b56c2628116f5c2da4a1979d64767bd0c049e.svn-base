...
public class DoctorOrganizationDepartmentRelationController {
	 ...
	 * @description: 新增关联
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:insert" }, level = Level.OPERATION)
	 ...
	 * @description: 删除关联
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:delete" }, level = Level.OPERATION)
	 ...
	 * @description: 关联列表
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:get-list" }, level = Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:get-member-list" }, level = Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:get-member-null-list" }, level = Level.OPERATION)
	 ...
	 * @description: 修改关联
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:update" }, level = Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:get-organization-member-not-in-this-team" },level = Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:insert-external" },level = Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication(value = { "web-module-organization-user:doctor-organization-department-duty:get-organization-not-member" },level = Level.OPERATION)
