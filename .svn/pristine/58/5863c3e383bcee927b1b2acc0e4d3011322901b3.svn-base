...
import org.web.module.base.service.data.currency.CodeTableService;
 ...
 * @author: LiuGangQiang
 * @date: 2018年11月15日
 * @description: CodeTableController
 */
@RestController
public class CodeTableController {
	...
	public JsonApi getDetail(@PathVariable("id") Integer id, @Validated(BaseEntity.SelectOne.class) CodeTable codeTable, BindingResult result) {
		codeTable.setId(id);
	...
	public JsonApi getList(@Validated(BaseEntity.SelectAll.class) CodeTable codeTable, BindingResult result) {
