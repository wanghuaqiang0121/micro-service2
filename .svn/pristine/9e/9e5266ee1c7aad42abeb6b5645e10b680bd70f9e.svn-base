...
public class ChildrenMeasureController {
	...
	public JsonApi newDetail(@PathVariable("userId") Integer userId,
			@Validated({ BaseEntity.SelectOne.class }) ChildrenMeasure childrenMeasure, BindingResult resul, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		/* 设置用户id */
	...
	public JsonApi getList(@PathVariable("userId") Integer userId,
			@Validated({ BaseEntity.SelectAll.class }) ChildrenMeasure childrenMeasure, BindingResult resul, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		/* 设置id */
		childrenMeasure.setUserId(userId);
	...
	public JsonApi getSynchronizationDate(@PathVariable("userId") Integer userId, ChildrenMeasure childrenMeasure , BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		childrenMeasure.setUserId(userId);
	...
	public JsonApi getSynchronizationChildrenDate(@PathVariable("userId") Integer userId, ChildrenMeasure childrenMeasure , BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		childrenMeasure.setUserId(userId);
		Map<String, Object> resultMap=new HashMap<>();
		/* 同步基本数据 */
	...
	public JsonApi getBoneAge(@PathVariable("userId") Integer userId,ChildrenMeasure childrenMeasure, BindingResult resul, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		/* 设置id */
		childrenMeasure.setUserId(userId);
		Map<String, Object> resultMap=new HashMap<>();
