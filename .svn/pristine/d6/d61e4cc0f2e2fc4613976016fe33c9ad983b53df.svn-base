...
public class StandardEerAmdrRni extends BaseEntity {
    /**
	 * @type: {@link long}
	 * @author: WangHuaQiang
	 * @date: 2019年1月30日
	 * @description: TODO
	 */
	private static final long serialVersionUID = -4873090632002967906L;
    ...
    public void setSaturatedFattyAcid(String saturatedFattyAcid) {
