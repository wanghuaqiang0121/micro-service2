...
import org.wechat.module.base.service.currency.SystemKeyInformationService;
...
public class SystemKeyInformationController {
	...
	public JsonApi getOne(@PathVariable("platform") String platform,
			@Validated({ BaseEntity.SelectOne.class }) SystemKeyInformation systemKeyInformation, BindingResult result) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, IOException {
		/* 设置条件 */
