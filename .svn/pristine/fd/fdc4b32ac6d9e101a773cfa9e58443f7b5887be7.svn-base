...
/**
 * {@link org.springframework.cache.CacheManager} backed by a {@link RedisCache
 * Redis} cache.
 * <p />
 * This cache manager creates caches by default upon first write. Empty caches
 * are not visible on Redis due to how Redis represents empty data structures.
 * <p />
 * Caches requiring a different {@link RedisCacheConfiguration} than the default
...
public class RedisCacheManager extends AbstractTransactionSupportingCacheManager {
	 ...
	 *            must not be {@literal null}. Maybe just use
	 ...
	 *            {@link RedisCacheConfiguration#defaultCacheConfig()}.
	 * @param allowInFlightCacheCreation
	 *            if set to {@literal true} no new caches can be acquire at runtime
	 *            but limited to the given list of initial cache names.
	 * @param initialCacheNames
	 *            optional set of known cache names that will be created with given
	 *            {@literal defaultCacheConfiguration}.
	 * @since 2.0.4
	 ...
	 *            Map of known cache names along with the configuration to use for
	 *            those caches. Must not be {@literal null}.
	 */
	public RedisCacheManager(RedisCacheWriter cacheWriter, RedisCacheConfiguration defaultCacheConfiguration,
	 ...
	 *            those caches. Must not be {@literal null}.
	 * @param allowInFlightCacheCreation
	 *            if set to {@literal false} this cache manager is limited to the
	 *            initial cache configurations and will not create new caches at
	 *            runtime.
	 * @since 2.0.4
	 */
	public RedisCacheManager(RedisCacheWriter cacheWriter, RedisCacheConfiguration defaultCacheConfiguration,
	 ...
	 * @description
	 */
	public void putSession(String cacheName, String token, Object data) {
		// 解密字符串
	 ...
	 * @param authenticationToken
	 * @return
	 * @description: 上个版本项目的获取token
	 */
	public AuthenticationSession getOldSession(AuthenticationToken authenticationToken) {
