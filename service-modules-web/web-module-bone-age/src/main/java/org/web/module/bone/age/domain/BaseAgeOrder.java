...
public class BaseAgeOrder extends BaseEntity {
	
	private static final long serialVersionUID = -4266505055218439661L;
    ...
    private Integer baseMedicalImagingDataId;
    ...
    public Integer getBaseMedicalImagingDataId() {
        return baseMedicalImagingDataId;
    }

    public void setBaseMedicalImagingDataId(Integer baseMedicalImagingDataId) {
        this.baseMedicalImagingDataId = baseMedicalImagingDataId;
    }
    ...
    public String getBase64BonePlot() {
        return base64BonePlot;
    }

    public void setBase64BonePlot(String base64BonePlot) {
        this.base64BonePlot = base64BonePlot;
    }
}