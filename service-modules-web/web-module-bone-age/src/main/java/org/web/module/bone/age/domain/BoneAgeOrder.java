...
public class BoneAgeOrder extends BaseEntity {
	...
	@NotNull(message = "{bone.age.order.user.id.notnull.valid}", groups = { Insert.class,LastOrder.class,Diagram.class })
	 ...
	 * @author: WangHuaQiang
	 * @date: 2019年3月12日
	 * @description: x光片是否被修改\n1.没有被修改\n2.被修改过（点击重新上传时状态为2，完成人工智能评测结果时状态为1，默认为1  ）
	 */
	private  Integer xRayIsUpdate;
	...
	public Integer getxRayIsUpdate() {
		return xRayIsUpdate;
	}

	public void setxRayIsUpdate(Integer xRayIsUpdate) {
		this.xRayIsUpdate = xRayIsUpdate;
	}
