...
public class User extends BaseEntity {
	...
	public UserCertificate getCertificateClamp() {
		return certificateClamp;
	}

	public void setCertificateClamp(UserCertificate certificateClamp) {
		this.certificateClamp = certificateClamp;
	}

	public List<UserCertificate> getCertificateClamps() {
		return certificateClamps;
	}

	public void setCertificateClamps(List<UserCertificate> certificateClamps) {
		this.certificateClamps = certificateClamps;
	}
