...
public class BehavioralDevelopmentConfigController {
	...
	public JsonApi insert(@Validated({ BaseEntity.Insert.class }) @RequestBody BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
	...
	public JsonApi update(@PathVariable("id") Integer id, @Validated({ BaseEntity.Update.class }) @RequestBody BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
	...
	public JsonApi getDetail(@PathVariable("id") Integer id, @Validated({ BaseEntity.SelectOne.class }) BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		behavioralDevelopmentConfig.setId(id);
		Map<String, Object> behavioralDevelopmentConfigMap = behavioralDevelopmentConfigService.getOne(behavioralDevelopmentConfig);
		if (behavioralDevelopmentConfigMap != null ) {
	...
	public JsonApi delete(@PathVariable("id") Integer id, @Validated({ BaseEntity.Delete.class }) BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		behavioralDevelopmentConfig.setId(id);
		/* 检查数据是否存在 */
	...
	public JsonApi getList(@Validated({ BaseEntity.SelectAll.class })  BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		...
		// 如果有月龄默认值，设置是否默认字段
		behavioralDevelopmentConfig.setChildrenMeasureId(null);
		behavioralDevelopmentConfig.setMonthAge(null);
	...
	public JsonApi getChildWarningSign(@Validated({ BaseEntity.SelectOne.class })  BehavioralDevelopmentConfig behavioralDevelopmentConfig, BindingResult result, @RequestHeader(required = true, value = BaseGlobal.TOKEN_FLAG) String token) {
		if (behavioralDevelopmentConfig.getChildrenMeasureId() != null) {
			ChildrenMeasure childrenMeasure = new ChildrenMeasure();
			childrenMeasure.setId(behavioralDevelopmentConfig.getChildrenMeasureId());
			Map<String, Object> childrenMeasureMap = childrenMeasureService.getOne(childrenMeasure);
