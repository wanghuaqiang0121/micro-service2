...
public interface ChildrenMeasureMapper extends IBaseMapper<ChildrenMeasure> {
	...
	List<Map<String, Object>> getListThreeDaysAgo(ChildrenMeasure childrenMeasure);

	Map<String, Object> getLastOne(ChildrenMeasure childrenMeasure);

	List<Map<String, Object>> getListByMonthAge2(ChildrenMeasure childrenMeasure);
