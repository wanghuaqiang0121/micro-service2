...
public class TeamOrganizationServicePackageRelationController {
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:insert" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:update" },level=Level.OPERATION)
	 ...
	 * @description: 团队服务包上架
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:on-the-shelf" },level=Level.OPERATION)
	 ...
	 * @description: 团队服务包下架
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:lower-frame" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:delete" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:get-list" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-organization:team-organization-service-package:get-teams-authorize" },level=Level.OPERATION)
