...
import org.web.module.team.domain.OrganizationTeam;
...
import org.web.module.team.service.OrganizationTeamService;
...
public class OrganizationTeamController {
	 ...
	 * @description: 新建机构团队
	 */
	@RequiresAuthentication( value = { "web-module-team:organization-team:insert" },level=Level.OPERATION)
	 ...
	 * @description:  修改机构团队
	 */
	@RequiresAuthentication( value = { "web-module-team:organization-team:update" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-team:organization-team:get-detail" },level=Level.OPERATION)
	 ...
	 */
	@RequiresAuthentication( value = { "web-module-team:organization-team:get-list" },level=Level.OPERATION)
