...
/**
 * {@link org.springframework.cache.Cache} implementation using for Redis as
 * underlying store.
 * <p />
...
public class RedisCache extends AbstractValueAdaptingCache {
	...
	protected Object lookup(Object key) {
		...
		/*
		 * 扩展 判断是否延期 延期则重新设置值，否则忽略
		 */
		Object result = deserializeCacheValue(value);
		if (getCacheConfiguration().useDelay()) {
			put(key, result);
		}
		return result;
	}
	...
	/**
	 * Convert {@code key} to a {@link String} representation used for cache key
	 * creation.
	 *
	 * @param key
	 *            will never be {@literal null}.
	 ...
	 *             if {@code key} cannot be converted to {@link String}.
	 */
